...
* It is a panel data consisting of $n=25$ households's purchases from $J=50$ cereal brands (in the application in the paper, we have a larger data set with $n=1880, J=101$).
